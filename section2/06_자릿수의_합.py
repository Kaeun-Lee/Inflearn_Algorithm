...
# My Solution 1 -> (정답) 문자열로 각 숫자를 분리한 뒤 더하기
import sys
...
# My Solution 2 -> (정답) list comprehension 이용
import sys
...
# Lecture Solution 1 -> 각 숫자를 10으로 나눈 나머지와 몫을 이용
import sys
...
# Lecture Solution 2 -> (pythonic한 방법) 문자열 이용
import sys
...
# < input >
# 50
# 401 100 932 79 822 233 192 18 491 965 34 477 255 948 906 959 528 949 200 138 886 66 535 337 493 154 500 717 336 99 849 390 578 659 853 216 590 417 447 724 507 208 675 377 824 780 708 482 790 127
