...
# My Solution -> (오답) 답을 맞히긴 했으나, round 함수로 인해 논리적 결함이 있음
import sys
...
# Lecture Solution -> half up 반올림, 하나의 for문으로 처리
# 오류 수정 : Python의 round()는 round_half_even 방식이므로, 반올림 계산 시 사용하면 X
...
# Another Solution -> list comprehension 이용
import sys
