...
# My Solution 1 -> (정답) -> 숫자를 문자열로 치환 후 뒤집음
import sys
import math
...
# Lecture Solution -> 숫자를 10으로 나눈 나머지와 몫을 이용하여 뒤집음
# reverse() 함수가 핵심!!
import sys
...
# Another Solution -> int를 사용하여 연속된 0을 제거
import sys
...
# < input >
# 12
# 50 91 457 52 699 170 413 54 416 97 199 33
...
# < input >
# 36
# 590 7628 27139 431 73 5652 11890 460 76 3452 2067 902 12 614 18039 518 71 5329 26422 793 41 8808 2878 10 720 49 2808 22122 611 91 8561 27991 408 54 4926 1395
